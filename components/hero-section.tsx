        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-16 flow-root sm:mt-24">
            <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
              <div className="rounded-md shadow-2xl ring-1 ring-gray-900/10 bg-white p-8 text-center">
                <div className="text-gray-500 text-lg">📊 AI Marketing Dashboard Preview</div>
                <div className="mt-4 text-sm text-gray-400">Interactive workflow builder coming soon</div>
              </div>
            </div>
          </div>
        </div>
